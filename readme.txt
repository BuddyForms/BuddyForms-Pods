...
= 1.0.6 - 23 Nov 2021 =
* Fixed issue with Pods fields validation.
* Fixed error with fields values from same post id.
...
* Improved the compatibility with BuddyForms 2.5.13.
